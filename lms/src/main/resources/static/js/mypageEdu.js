...
function userDataSet(responseId) {
  ...
  const element1 = (document.getElementById("classGraphBar1").style.height =
    classValue1 * 30 + "px");
  const element2 = (document.getElementById("classGraphBar2").style.height =
    classValue2 * 30 + "px");
  const element3 = (document.getElementById("classGraphBar3").style.height =
    classValue3 * 30 + "px");
  const element4 = (document.getElementById("classGraphBar4").style.height =
    classValue4 * 30 + "px");
  const element5 = (document.getElementById("classGraphBar5").style.height =
    classValue5 * 30 + "px");
  const element6 = (document.getElementById("classGraphBar6").style.height =
    classValue6 * 30 + "px");
  const element7 = (document.getElementById("classGraphBar7").style.height =
    classValue7 * 30 + "px");
}
...
function usergraphSet(responseId) {
  ...
  let myLecture = [];
  axios.get(urlRegi).then((response) => {
    console.log("응답 Response: ", response);
