...
let url = "http://localhost:8080/api/course/queryCLCJPQL/";
...
searchButton.addEventListener("click", () => {
  ...
  if (userName.length > 0) {
    url = "http://localhost:8080/api/course/queryCLCJPQL/" + userName;
  } else {
    url = "http://localhost:8080/api/course/queryCLCJPQL/";
  }
